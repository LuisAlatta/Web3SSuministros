...
export const productos = [
  ...
  { name: "Taladros y rotomartillos", cat: "herramientas", marca: "Bosch", img: "taladros" },
  { name: "Amoladoras angulares", cat: "herramientas", marca: "Makita", img: "amoladoras" },
  { name: "Atornilladores inalámbricos", cat: "herramientas", marca: "DeWalt", img: "atornilladores" },
  { name: "Llaves, dados y juegos de mano", cat: "herramientas", marca: "Stanley", img: "llaves-dados" },
  { name: "Sierras y equipos de demolición", cat: "herramientas", marca: "Milwaukee", img: "sierras" },
  { name: "Herramienta manual en general", cat: "herramientas", marca: "Truper", img: "herramienta-manual" },
  { name: "Llaves ajustables y de golpe", cat: "herramientas", marca: "Bahco", img: "llaves-ajustables" },
  { name: "Multímetros y pinzas amperimétricas", cat: "herramientas", marca: "Fluke", img: "multimetros" },
  { name: "Calibradores y micrómetros", cat: "herramientas", marca: "Mitutoyo", img: "calibradores" },
  // Seguridad industrial (EPP)
  { name: "Cascos de seguridad", cat: "seguridad", marca: "MSA", img: "cascos" },
  { name: "Respiradores y mascarillas", cat: "seguridad", marca: "3M", img: "respiradores" },
  { name: "Guantes de protección", cat: "seguridad", marca: "Ansell", img: "guantes" },
  { name: "Guantes recubiertos", cat: "seguridad", marca: "Showa", img: "guantes-recubiertos" },
  { name: "Trajes y overoles Tyvek", cat: "seguridad", marca: "DuPont", img: "tyvek" },
  { name: "Lentes, caretas y protección facial", cat: "seguridad", marca: "Steelpro", img: "lentes" },
  { name: "Arnés y líneas de vida", cat: "seguridad", marca: "MSA", img: "arnes" },
  { name: "Calzado de seguridad", cat: "seguridad", marca: "Delta Plus", img: "calzado" },
  { name: "Protección auditiva", cat: "seguridad", marca: "3M", img: "auditiva" },
  // Contención de derrames
  { name: "Paños absorbentes de aceite (Clot Oil)", cat: "derrames", marca: "", img: "oil" },
  { name: "Absorbentes universales", cat: "derrames", marca: "", img: "universal" },
  { name: "Absorbentes de químicos", cat: "derrames", marca: "", img: "quimicos" },
  { name: "Rollo de paños X80 multiuso", cat: "derrames", marca: "", img: "rollo" },
  { name: "Kit de derrame 30 L y 50 L", cat: "derrames", marca: "", img: "kit" },
  { name: "Contenedor de aceites portátil", cat: "derrames", marca: "", img: "contenedor" },
  { name: "Tapetes absorbentes para cilindro", cat: "derrames", marca: "", img: "tapetes" },
  // Equipos eléctricos
  { name: "Cables eléctricos", cat: "electricos", marca: "", img: "cables" },
  { name: "Luminarias industriales", cat: "electricos", marca: "", img: "luminarias" },
  { name: "Motores eléctricos", cat: "electricos", marca: "", img: "motores-electricos" },
  { name: "Accesorios eléctricos (industria y hogar)", cat: "electricos", marca: "", img: "accesorios-electricos" },
  { name: "Tableros y arrancadores", cat: "electricos", marca: "", img: "tableros" },
  // Izaje y sistemas
  { name: "Estrobos de cable SuperLoop", cat: "izaje", marca: "Bridon-Bekaert", img: "estrobo" },
  { name: "Cadenas de izaje grado 8", cat: "izaje", marca: "Bridon-Bekaert", img: "cadenas" },
  { name: "Eslingas sintéticas Strongloop", cat: "izaje", marca: "Bridon-Bekaert", img: "eslinga" },
  { name: "Eslingas Dyneema (roundslings)", cat: "izaje", marca: "Bridon-Bekaert", img: "roundsling" },
  { name: "Grilletes y ganchos", cat: "izaje", marca: "Crosby", img: "grillete" },
  { name: "Guardacabos y casquillos S-505", cat: "izaje", marca: "Crosby", img: "guardacabo" },
  { name: "Tensores de amarre (tie-down)", cat: "izaje", marca: "", img: "tensor" },
  { name: "Almohadillas HARDPAD Crane", cat: "izaje", marca: "Línea propia 3S", img: "hardpad" },
  { name: "Polipastos, frenos y ejes", cat: "izaje", marca: "", img: "polipastos" },
  { name: "Ganchos, piñones y rotores", cat: "izaje", marca: "", img: "gancho" },
  { name: "Bombas centrífugas y sumergibles", cat: "izaje", marca: "", img: "bombas" },
  { name: "Válvulas (cheque, alivio y mariposa)", cat: "izaje", marca: "", img: "valvulas" },
  { name: "Compresores y filtros de aire/fluidos", cat: "izaje", marca: "", img: "compresores" },
  // Transmisión de potencia
  { name: "Rodamientos especiales", cat: "transmision", marca: "", img: "rodamientos" },
  { name: "Chumaceras", cat: "transmision", marca: "", img: "chumaceras" },
  { name: "Cadenas y correas de transmisión", cat: "transmision", marca: "", img: "correas" },
  { name: "Acoples y ejes", cat: "transmision", marca: "", img: "acoples" },
  { name: "Reductores", cat: "transmision", marca: "", img: "reductores" },
  { name: "Motores AC / DC", cat: "transmision", marca: "", img: "motores-acdc" },
  // Ferretería en general
  { name: "Pernos, tuercas y arandelas (negro / inox)", cat: "ferreteria", marca: "", img: "pernos" },
  { name: "Lonas contra lluvias", cat: "ferreteria", marca: "Lonatex", img: "lonas" },
  { name: "Sogas de nylon", cat: "ferreteria", marca: "", img: "sogas" },
  { name: "Trapo industrial", cat: "ferreteria", marca: "", img: "trapo" },
  { name: "Conos de seguridad", cat: "ferreteria", marca: "", img: "conos" },
  { name: "Escaleras", cat: "ferreteria", marca: "", img: "escaleras" },
  { name: "Pinturas ignífugas importadas", cat: "ferreteria", marca: "Titán", img: "pinturas" },
  { name: "Tubería PVC y cintillos", cat: "ferreteria", marca: "Pavco", img: "tuberia-pvc" },
  { name: "Mallas de cerco (acero o rachel)", cat: "ferreteria", marca: "", img: "mallas" },
  { name: "Vigas metálicas y planchas de acero", cat: "ferreteria", marca: "", img: "vigas" },
] as const;
